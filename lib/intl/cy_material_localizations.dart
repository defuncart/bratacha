...
// Taken from https://github.com/flutter/website/blob/master/examples/internationalization/add_language/lib/main.dart
class _CyMaterialLocalizationsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _CyMaterialLocalizationsDelegate();
  ...
  @override
  bool shouldReload(_CyMaterialLocalizationsDelegate old) => false;
}
...
class CyMaterialLocalizations extends GlobalMaterialLocalizations {
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _CyMaterialLocalizationsDelegate();
